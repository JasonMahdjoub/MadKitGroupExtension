...
/** 
 * The class Watcher of MadKitGroupExtension inherits from the class Watcher of MadKit. 
...
@Override public ReturnCode bucketModeRequestRole(Group _group, final String role) {
    ...
    @Deprecated @Override public Set<madkit.kernel.Probe<? extends madkit.kernel.AbstractAgent>> getProbes()
    {
	throw new IllegalAccessError("This method is deprecated, and connot be called");
    }
    ...
    @Override 
    public synchronized Probe<?>[] probes()
    {
	return m_probes.toArray(new Probe<?>[m_probes.size()]);
    }
